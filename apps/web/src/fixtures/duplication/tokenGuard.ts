/**
 * BENCHMARK FIXTURE: CROSS-PACKAGE DUPLICATION (Source Clone)
 * Target tool: jscpd
 * 35 lines of identical token validation duplicated in apps/api
 */
...
export function validateAuthTokenHeader(
  token: string,
