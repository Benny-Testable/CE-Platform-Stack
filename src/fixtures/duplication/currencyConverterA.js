 ...
 * Target tool: jscpd
 * 35 lines of identical pure JS currency conversion logic duplicated in currencyConverterB.js
 */
export function convertCurrencyA(amount, fromCurr, toCurr, isVip) {
